...
namespace CleanArchitecture.Infrastructure
{
    public static class ServiceRegistration
    {
        public static void AddPersistenceInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<IFollowRepositoryAsync, FollowRepositoryAsync>();
            services.AddTransient<ILikeRepositoryAsync, LikeRepositoryAsync>();
            services.AddTransient<IDislikeRepositoryAsync, DislikeRepositoryAsync>();
            services.AddTransient<ISaveRepositoryAsync, SaveRepositoryAsync>();
            services.AddTransient<ICommentRepositoryAsync, CommentRepositoryAsync>();
            services.AddTransient<IBadgeRepositoryAsync, BadgeRepositoryAsync>();
