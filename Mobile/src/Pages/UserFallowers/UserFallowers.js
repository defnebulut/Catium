...
function UserFallowers({navigation}){
    ...
    const fetchData = async () => {
        ...
        try {
          setLoading(true)
          const response = await axios.get(`https://catium.azurewebsites.net/api/v1/FollowerList?id=${parsedUserInfo.data.id}`);
