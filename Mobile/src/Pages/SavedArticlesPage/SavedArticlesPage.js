...
function SavedArticlesPage({navigation}){
  ...
  const fetchArticles = async () => {
      ...
      const response = await axios.get(`https://catium.azurewebsites.net/api/v1/SavedArticle?id=${parsedUserInfo.data.id}`);
  ...
  function Header(){
    return(
      ...
      <View>
        <Text style={{textAlign:'center',fontSize:20,fontWeight:'800',padding:15}}>Your Saved Articles</Text>
    </View>
      )
  }
  return (
