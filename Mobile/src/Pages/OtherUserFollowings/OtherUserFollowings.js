...
function OtherUserFallowings({navigation,userId}){
    ...
    const fetchData = async () => {
        ...
        try {
          setLoading(true)
          const response = await axios.get(`https://catium.azurewebsites.net/api/v1/FollowedList?id=${userId}`);
...
export default OtherUserFallowings;