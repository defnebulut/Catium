...
const Datatableadmins = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://catium.azurewebsites.net/api/Account/admin");
  ...
  const handleDelete = async (userId) => {
    ...
    try {
      const response = await axios.delete(`https://catium.azurewebsites.net/api/Account/admin-delete?adminId=${userId}`);
    ...
    <div className="datatable-container">
      ...
      {deleteSuccess && (
        <div className="popup-container">
          <div className="popup">
            <div className="popup-content">
              <p>This admin deleted successfully!</p>
              <button
      ...
      {deleteError && (
        <div className="popup-container">
          <div className="popup">
            <div className="popup-content">
              <p>
                An error occurred while deleting: this admin may already
